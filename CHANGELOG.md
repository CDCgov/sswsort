...
- Changes internal API to remove deprecated `FastaNTAnnot` struct from Zoe and
  replace it with an SSWSort-specific `Reference` struct
...
- Bump dependencies and add better image metadata
...
<!-- Versions -->
[2.2.6-dev]: https://github.com/CDCgov/sswsort/compare/v2.2.5...v2.2.6
